  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        ...
        <div><label className="block text-sm font-medium mb-2">Remaining Term (years)</label><input type="number" min="1" max="35" value={years} onChange={(e) => setYears(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="Remaining Term (years)" /></div>
        <div><label className="block text-sm font-medium mb-2">ERC Rate (%)</label><input type="number" min="0" max="5" step="0.5" value={ercPct} onChange={(e) => setErcPct(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="ERC Rate (%)" /></div>
