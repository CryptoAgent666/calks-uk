...
function calculate(monthlyDeposit: number, currentBalance: number, years: number, growthRate: number, dividendYield: number) {
  ...
  const dividendTaxSaved = totalDividends * 0.1075 // basic rate
