  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div><label className="block text-sm font-medium mb-2">Person 1 Pension</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">£</span><input type="text" inputMode="numeric" value={p1} onChange={(e) => setP1(e.target.value)} className="w-full rounded-xl border border-input bg-background px-8 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="Person 1 Pension" /></div></div>
        <div><label className="block text-sm font-medium mb-2">Person 2 Pension</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">£</span><input type="text" inputMode="numeric" value={p2} onChange={(e) => setP2(e.target.value)} className="w-full rounded-xl border border-input bg-background px-8 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="Person 2 Pension" /></div></div>
        <div><label className="block text-sm font-medium mb-2">P1 State Pension (£/wk)</label><input type="number" min="0" max="300" value={sp1} onChange={(e) => setSp1(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="P1 State Pension (£/wk)" /></div>
        <div><label className="block text-sm font-medium mb-2">P2 State Pension (£/wk)</label><input type="number" min="0" max="300" value={sp2} onChange={(e) => setSp2(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="P2 State Pension (£/wk)" /></div>
      </div>
