  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        <div><label className="block text-sm font-medium mb-2">Battery Size (kWh)</label><input type="number" min="10" max="200" value={battery} onChange={(e) => setBattery(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="Battery Size (kWh)" /></div>
        <div><label className="block text-sm font-medium mb-2">Current Charge (%)</label><input type="number" min="0" max="100" value={current} onChange={(e) => setCurrent(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="Current Charge (%)" /></div>
        <div><label className="block text-sm font-medium mb-2">Target Charge (%)</label><input type="number" min="0" max="100" value={target} onChange={(e) => setTarget(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="Target Charge (%)" /></div>
        <div><label className="block text-sm font-medium mb-2">Home Rate (p/kWh)</label><input type="number" min="0" step="0.1" value={homeRate} onChange={(e) => setHomeRate(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="Home Rate (p/kWh)" /></div>
        <div><label className="block text-sm font-medium mb-2">Public Rate (p/kWh)</label><input type="number" min="0" step="1" value={publicRate} onChange={(e) => setPublicRate(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="Public Rate (p/kWh)" /></div>
        <div><label className="block text-sm font-medium mb-2">Efficiency (mi/kWh)</label><input type="number" min="1" max="6" step="0.1" value={efficiency} onChange={(e) => setEfficiency(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="Efficiency (mi/kWh)" /></div>
      </div>
