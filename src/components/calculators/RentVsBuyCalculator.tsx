  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div><label className="block text-sm font-medium mb-2">Rent Growth (%/yr)</label><input type="number" min="0" max="15" step="0.5" value={rGrowth} onChange={(e) => setRGrowth(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="Rent Growth (%/yr)" /></div>
        <div><label className="block text-sm font-medium mb-2">Comparison Period (years)</label><input type="number" min="1" max="40" value={years} onChange={(e) => setYears(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring"  aria-label="Comparison Period (years)" /></div>
      </div>
