...
// Benefit cap 2025/26
const CAPS = {
  single_london: 1_284.17 * 12, // monthly x 12
  couple_london: 1_916.67 * 12,
  single_outside: 1_116.67 * 12,
  couple_outside: 1_666.67 * 12,
}
