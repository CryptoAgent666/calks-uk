    ...
    <div className="space-y-8">
      <div className="rounded-xl border border-border p-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-2">Angle</label><input type="number" step="any" value={angle} onChange={(e) => setAngle(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 text-lg font-medium focus:outline-none focus:ring-2 focus:ring-ring" /></div>
      ...
      <div className="rounded-xl border border-border p-5 space-y-4">
        ...
        <div><label className="block text-sm font-medium mb-2">Value</label><input type="number" step="0.01" min="-1" max="99" value={invValue} onChange={(e) => setInvValue(e.target.value)} className="w-full rounded-xl border border-input bg-background px-4 py-3 font-medium focus:outline-none focus:ring-2 focus:ring-ring" /></div>
