  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div><label className="block text-sm font-medium mb-2">Living Situation</label><select value={living} onChange={(e) => setLiving(e.target.value as LivingSituation)} className="w-full rounded-xl border border-input bg-background px-4 py-3 text-lg font-medium focus:outline-none focus:ring-2 focus:ring-ring"><option value="home_parents">Living with Parents</option><option value="home_away">Away from Home</option><option value="london">London</option></select></div>
      </div>
