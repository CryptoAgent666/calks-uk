...
export const CALCULATORS: CalculatorMeta[] = [
  ...
  },
  {
    ...
    description: 'Estimate inheritance tax liability on your estate. Includes nil-rate band, residence nil-rate band and spouse exemption.',
    category: 'tax',
    icon: 'Receipt',
  ...
  },
  {
    ...
    description: 'Calculate UK corporation tax at 25% (main rate) or 19% (small profits rate) with marginal relief.',
    category: 'tax',
    icon: 'Receipt',
  ...
  },
  {
    ...
    description: 'Calculate tax on dividends with the £500 dividend allowance and rates for basic, higher and additional rate taxpayers.',
    category: 'tax',
    icon: 'Receipt',
  ...
  },
  {
    ...
    description: 'Calculate SMP entitlement: 6 weeks at 90% of average earnings, then up to 33 weeks at the statutory rate.',
    category: 'pay',
    icon: 'Banknote',
  ...
  },
  {
    ...
    description: 'Find out how much you could borrow based on your income, expenses and deposit. Uses typical UK lender criteria.',
    category: 'mortgage',
    icon: 'Home',
  ...
  },
  {
    ...
    description: 'See how much time and interest you could save by making regular or one-off overpayments on your mortgage.',
    category: 'mortgage',
    icon: 'Home',
  ...
  },
  {
    ...
    description: 'Calculate gross and net rental yield on buy-to-let investment properties.',
    category: 'mortgage',
    icon: 'Home',
  ...
  // ========================================
  {
    ...
    description: 'Calculate your workplace pension contributions and projected pot at retirement under auto-enrolment.',
    category: 'pension',
    icon: 'PiggyBank',
  ...
  },
  {
    ...
    description: 'Estimate your UK State Pension based on your National Insurance record. Full new State Pension is £230.25 per week.',
    category: 'pension',
    icon: 'PiggyBank',
  ...
  },
  {
    ...
    description: 'Calculate how much tax relief you get on pension contributions as a basic, higher or additional rate taxpayer.',
    category: 'pension',
    icon: 'PiggyBank',
  ...
  },
  {
    ...
    description: 'Calculate monthly repayments, total interest and total cost of a personal loan.',
    category: 'loans',
    icon: 'CreditCard',
  ...
  },
  {
    ...
    description: 'Compare PCP, Hire Purchase and personal loan monthly payments for buying a car.',
    category: 'loans',
    icon: 'CreditCard',
  ...
  },
  {
    ...
    description: 'Estimate annuity income from your pension pot. Compare single and joint life annuity rates by age.',
    category: 'pension',
    icon: 'PiggyBank',
  ...
  { slug: 'income-protection-calculator', title: 'Income Protection Calculator', description: 'Calculate income protection cover needed and estimate monthly premiums by age and deferral period.', category: 'insurance', icon: 'ShieldCheck', keywords: ['income protection', 'income insurance', 'sick cover', 'disability insurance'], priority: 2 },
  { slug: 'travel-insurance-calculator', title: 'Travel Insurance Calculator', description: 'Estimate travel insurance premiums for Europe and worldwide trips. Compare cover levels.', category: 'insurance', icon: 'ShieldCheck', keywords: ['travel insurance', 'holiday insurance', 'medical cover', 'trip insurance'], priority: 2 },
  // LEGAL (additional)
  { slug: 'spousal-maintenance-calculator', title: 'Spousal Maintenance Calculator', description: 'Estimate spousal maintenance range for divorce. Based on income difference and length of marriage.', category: 'legal', icon: 'Scale', keywords: ['spousal maintenance', 'alimony', 'divorce maintenance', 'spousal support'], priority: 2 },
  // EDUCATION (additional)
  { slug: 'gcse-grade-calculator', title: 'GCSE Grade Calculator (9-1)', description: 'Calculate Attainment 8 score, average grade and pass counts from your GCSE grades.', category: 'education', icon: 'GraduationCap', keywords: ['GCSE', 'GCSE grades', 'attainment 8', '9-1 grades', 'school results'], priority: 1 },
  { slug: 'university-cost-calculator', title: 'University Cost Calculator', description: 'Calculate the total cost of university including tuition fees, maintenance loan and living costs.', category: 'education', icon: 'GraduationCap', keywords: ['university cost', 'uni fees', 'student debt', 'tuition fees', 'student finance'], priority: 2 },
  // GARDENING (additional)
  { slug: 'greenhouse-size-calculator', title: 'Greenhouse Size Calculator', description: 'Calculate greenhouse growing capacity. See how many plants fit by type with common size presets.', category: 'gardening', icon: 'Flower2', keywords: ['greenhouse', 'greenhouse size', 'growing space', 'greenhouse plants'], priority: 2 },
  { slug: 'pond-volume-calculator', title: 'Pond Volume Calculator', description: 'Calculate pond volume in litres, pump size and liner dimensions for rectangle, circle or oval ponds.', category: 'gardening', icon: 'Flower2', keywords: ['pond volume', 'pond calculator', 'pond liner', 'garden pond'], priority: 2 },
  // TAX (additional)
  { slug: 'side-hustle-tax-calculator', title: 'Side Hustle / Trading Allowance Calculator', description: 'Calculate tax on side hustle income. Use the £1,000 trading allowance or claim actual expenses.', category: 'tax', icon: 'Receipt', keywords: ['side hustle', 'trading allowance', 'extra income', 'freelance tax'], priority: 2 },
  // LEGAL (additional)
  { slug: 'employment-tribunal-calculator', title: 'Employment Tribunal Award Calculator', description: 'Estimate unfair dismissal tribunal awards — basic award and compensatory award.', category: 'legal', icon: 'Scale', keywords: ['employment tribunal', 'unfair dismissal', 'tribunal award', 'compensation'], priority: 2 },
  // CONSTRUCTION (additional)
  { slug: 'roof-tiles-calculator', title: 'Roof Tiles Calculator', description: 'Calculate roof tiles, ridge tiles, batten and felt needed based on roof dimensions and pitch.', category: 'building', icon: 'Hammer', keywords: ['roof tiles', 'roofing', 'slate', 'ridge tiles', 'roof area'], priority: 2 },
  // ENERGY (additional)
  ...
  { slug: 'ltv-calculator', title: 'Loan-to-Value (LTV) Calculator', description: 'Calculate your LTV ratio and see how it affects mortgage rates and borrowing options.', category: 'mortgage', icon: 'Home', keywords: ['LTV', 'loan to value', 'equity', 'mortgage ratio'], priority: 2 },
  ...
  { slug: 'debt-to-income-calculator', title: 'Debt-to-Income Ratio Calculator', description: 'Calculate your DTI ratio to see if lenders will approve your mortgage or loan application.', category: 'mortgage', icon: 'Home', keywords: ['debt to income', 'DTI', 'affordability', 'lending ratio'], priority: 2 },
  // LOANS (additional)
  ...
  { slug: 'area-converter', title: 'Area Converter (m² / ft² / acres)', description: 'Convert between square metres, square feet, acres, hectares and more. Includes all common UK area units with instant results.', category: 'tools', icon: 'Wrench', keywords: ['area converter', 'square feet', 'acres', 'hectares', 'square metres'], priority: 2 },
  { slug: 'cooking-converter', title: 'Cooking Measurement Converter', description: 'Convert between ml, cups, tablespoons, pints and ounces. Includes gas mark to °C/°F chart.', category: 'tools', icon: 'Wrench', keywords: ['cooking converter', 'cups to ml', 'tablespoon', 'gas mark', 'recipe converter'], priority: 2 },
  { slug: 'timezone-converter', title: 'Time Zone Converter', description: 'Convert times between 15+ world time zones. See all zones at a glance.', category: 'tools', icon: 'Wrench', keywords: ['timezone', 'time zone', 'world clock', 'time difference'], priority: 2 },
  // IMMIGRATION (additional)
  { slug: 'ilr-calculator', title: 'ILR Eligibility Calculator', description: 'Check if you qualify for Indefinite Leave to Remain based on your visa route, time in UK and absences.', category: 'immigration', icon: 'Globe', keywords: ['ILR', 'indefinite leave', 'settlement', 'permanent residence'], priority: 1 },
  // HEALTH (additional)
  { slug: 'steps-to-miles-calculator', title: 'Steps to Miles/Km Calculator', description: 'Convert steps to distance, calories and walking time based on your height and stride length.', category: 'health', icon: 'Heart', keywords: ['steps', 'steps to miles', 'walking distance', 'step counter', 'pedometer'], priority: 2 },
  { slug: 'heart-rate-zone-calculator', title: 'Heart Rate Zone Calculator', description: 'Calculate your 5 heart rate training zones using the Karvonen formula with resting heart rate.', category: 'health', icon: 'Heart', keywords: ['heart rate zones', 'training zones', 'max heart rate', 'Karvonen', 'cardio zones'], priority: 2 },
  // MATH (additional)
  { slug: 'probability-calculator', title: 'Probability Calculator', description: 'Calculate event probabilities, combinations and permutations. P(A or B), P(A and B), nCr, nPr.', category: 'math', icon: 'Calculator', keywords: ['probability', 'combinations', 'permutations', 'nCr', 'nPr', 'odds'], priority: 2 },
  // TAX
  { slug: 'annual-tax-summary-calculator', title: 'Annual Tax Summary Calculator', description: 'Calculate your total tax bill from all income sources — salary, dividends, self-employment, rental and capital gains.', category: 'tax', icon: 'Receipt', keywords: ['annual tax', 'tax summary', 'total tax', 'all income', 'tax bill'], priority: 1 },
  // BUSINESS
  { slug: 'business-rates-calculator', title: 'Business Rates Calculator', description: 'Calculate business rates from rateable value. Includes Small Business Rate Relief.', category: 'business', icon: 'Briefcase', keywords: ['business rates', 'rateable value', 'SBRR', 'commercial property'], priority: 2 },
  { slug: 'rd-tax-credit-calculator', title: 'R&D Tax Credit Calculator', description: 'Estimate R&D tax credits for profitable and loss-making companies under the merged RDEC scheme.', category: 'business', icon: 'Briefcase', keywords: ['R&D', 'tax credits', 'RDEC', 'research development', 'innovation'], priority: 2 },
  { slug: 'cis-calculator', title: 'CIS Subcontractor Tax Calculator', description: 'Calculate CIS deductions on subcontractor invoices at 20%, 30% or gross payment status.', category: 'business', icon: 'Briefcase', keywords: ['CIS', 'construction industry scheme', 'subcontractor', 'CIS deduction'], priority: 2 },
  // INSURANCE
  ...
  // HEALTH
  { slug: 'weight-loss-calculator', title: 'Weight Loss Calculator', description: 'Calculate how long to reach your target weight with milestones and daily calorie deficit.', category: 'health', icon: 'Heart', keywords: ['weight loss', 'lose weight', 'diet calculator', 'calorie deficit'], priority: 2 },
  { slug: 'protein-intake-calculator', title: 'Protein Intake Calculator', description: 'Calculate daily protein needs by weight and goal. See common protein sources per serving.', category: 'health', icon: 'Heart', keywords: ['protein', 'protein intake', 'daily protein', 'macros', 'muscle building'], priority: 2 },
  { slug: 'ovulation-calculator', title: 'Ovulation Calculator', description: 'Estimate ovulation date and fertile window based on your last period and cycle length. See 3 cycles ahead.', category: 'health', icon: 'Heart', keywords: ['ovulation', 'fertile window', 'conception', 'period tracker', 'fertility'], priority: 2 },
  // AUTO
  { slug: 'car-lease-vs-buy-calculator', title: 'Car Lease vs Buy Calculator', description: 'Compare leasing vs buying a car on finance. See which is cheaper after depreciation and interest.', category: 'auto', icon: 'Car', keywords: ['lease vs buy', 'car lease', 'PCH', 'car finance comparison'], priority: 2 },
  // BUSINESS
  ...
  // CONSTRUCTION
  { slug: 'plaster-calculator', title: 'Plaster Calculator — Bags & Coverage', description: 'Calculate plaster needed in 25kg bags for skim coat, bonding/browning or one-coat plaster.', category: 'building', icon: 'Hammer', keywords: ['plaster', 'plastering', 'skim coat', 'bonding', 'browning'], priority: 2 },
  { slug: 'staircase-calculator', title: 'Staircase Calculator', description: 'Calculate risers, treads, pitch and going for a staircase. Checks Building Regulations Part K compliance.', category: 'building', icon: 'Hammer', keywords: ['staircase', 'stairs', 'risers', 'treads', 'building regs'], priority: 2 },
  // EDUCATION
  { slug: 'exam-score-calculator', title: 'Exam Score Calculator', description: 'Calculate exam percentage and grade. Find out what score you need on remaining papers to hit your target.', category: 'education', icon: 'GraduationCap', keywords: ['exam score', 'grade calculator', 'marks needed', 'pass mark'], priority: 2 },
  // MATH
  { slug: 'roman-numeral-converter', title: 'Roman Numeral Converter', description: 'Convert between decimal numbers and Roman numerals (I, V, X, L, C, D, M). Both directions.', category: 'math', icon: 'Calculator', keywords: ['roman numerals', 'roman numbers', 'numeral converter', 'MMXXV'], priority: 2 },
  // BUSINESS
  { slug: 'capital-allowances-calculator', title: 'Capital Allowances Calculator', description: 'Calculate AIA, Full Expensing or Writing Down Allowance on business assets. See year-by-year tax relief.', category: 'business', icon: 'Briefcase', keywords: ['capital allowances', 'AIA', 'full expensing', 'writing down allowance', 'WDA'], priority: 2 },
  { slug: 'cash-flow-calculator', title: 'Cash Flow Calculator', description: 'Project monthly cash flow with income and expenses. See closing balance and lowest point.', category: 'business', icon: 'Briefcase', keywords: ['cash flow', 'cash flow forecast', 'business planning', 'liquidity'], priority: 2 },
  // IMMIGRATION
  { slug: 'spouse-visa-calculator', title: 'UK Spouse Visa Income Calculator', description: 'Check if you meet the £29,000 minimum income for a UK Spouse visa. Includes savings calculation and total visa costs.', category: 'immigration', icon: 'Globe', keywords: ['spouse visa', 'partner visa', 'minimum income', 'family visa'], priority: 1 },
  // FARMING
  { slug: 'farm-operating-cost-calculator', title: 'Farm Operating Cost Calculator', description: 'Calculate per-hectare costs and profitability for arable farming. See break-even price per tonne.', category: 'farming', icon: 'Wheat', keywords: ['farm costs', 'arable', 'farming profit', 'cost per hectare', 'break even'], priority: 1 },
  // LEGAL
  { slug: 'personal-injury-calculator', title: 'Personal Injury Compensation Calculator', description: 'Estimate personal injury compensation based on Judicial College Guidelines for common injury types.', category: 'legal', icon: 'Scale', keywords: ['personal injury', 'compensation', 'whiplash claim', 'accident claim'], priority: 2 },
  // INVESTMENT
  { slug: 'investment-return-calculator', title: 'Investment Return Calculator', description: 'Calculate nominal and real (inflation-adjusted) investment returns with monthly contributions over time.', category: 'investment', icon: 'TrendingUp', keywords: ['investment return', 'portfolio growth', 'nominal return', 'real return'], priority: 1 },
  { slug: 'savings-interest-tax-calculator', title: 'Savings Interest Tax Calculator', description: 'Calculate tax on savings interest above your Personal Savings Allowance. See max tax-free savings.', category: 'investment', icon: 'TrendingUp', keywords: ['savings interest', 'PSA', 'personal savings allowance', 'tax on savings'], priority: 2 },
  { slug: 'real-return-calculator', title: 'Real Return Calculator (After Inflation)', description: 'Calculate the real return on investments after accounting for inflation. See purchasing power impact.', category: 'investment', icon: 'TrendingUp', keywords: ['real return', 'after inflation', 'purchasing power', 'inflation adjusted'], priority: 2 },
  ...
  // PAY
  { slug: 'freelance-tax-calculator', title: 'Freelance Tax Calculator', description: 'Calculate freelancer take-home pay from day rate. Includes tax, NI, expenses and VAT threshold warning.', category: 'pay', icon: 'Banknote', keywords: ['freelance tax', 'freelancer', 'day rate tax', 'self employed'], priority: 1 },
  // HEALTH
  { slug: 'macro-calculator', title: 'Macro Calculator — Protein, Carbs & Fat', description: 'Calculate daily protein, carbs and fat targets based on your body stats, activity and goal.', category: 'health', icon: 'Heart', keywords: ['macros', 'macro calculator', 'protein carbs fat', 'nutrition', 'IIFYM'], priority: 2 },
  // TOOLS
  { slug: 'cost-of-living-calculator', title: 'Cost of Living Calculator', description: 'Track monthly expenses against take-home pay. See surplus or shortfall with editable UK average costs.', category: 'tools', icon: 'Wrench', keywords: ['cost of living', 'budget', 'monthly expenses', 'living costs', 'affordability'], priority: 1 },
  { slug: 'smart-meter-calculator', title: 'Smart Meter / Appliance Cost Calculator', description: 'Calculate daily electricity cost from individual appliances. Adjust usage hours for each device.', category: 'energy', icon: 'Zap', keywords: ['smart meter', 'appliance cost', 'electricity usage', 'device cost'], priority: 2 },
  { slug: 'gpa-calculator', title: 'GPA Calculator (UK)', description: 'Calculate UK GPA from module grades and credits. See degree classification equivalent.', category: 'education', icon: 'GraduationCap', keywords: ['GPA', 'grade point average', 'degree class', 'university grades'], priority: 2 },
  { slug: 'solicitor-fee-calculator', title: 'Solicitor Fee Estimate Calculator', description: 'Estimate solicitor fees for conveyancing, divorce, wills, probate and employment matters.', category: 'legal', icon: 'Scale', keywords: ['solicitor fees', 'legal fees', 'conveyancing cost', 'divorce cost', 'will cost'], priority: 1 },
  { slug: 'divorce-settlement-calculator', title: 'Divorce Financial Settlement Calculator', description: 'Estimate how assets might be split in a divorce — property, pensions, savings and debts.', category: 'legal', icon: 'Scale', keywords: ['divorce settlement', 'financial split', 'matrimonial assets', 'divorce calculator'], priority: 2 },
  { slug: 'uk-citizenship-calculator', title: 'UK Citizenship Eligibility Calculator', description: 'Check citizenship eligibility after ILR. See timeline, absence limits and total application costs.', category: 'immigration', icon: 'Globe', keywords: ['citizenship', 'naturalisation', 'British citizenship', 'citizenship cost'], priority: 2 },
  { slug: 'free-school-meals-calculator', title: 'Free School Meals Eligibility Calculator', description: 'Check if your children qualify for free school meals. See annual savings and qualifying benefits.', category: 'benefits', icon: 'Shield', keywords: ['free school meals', 'FSM', 'school dinners', 'pupil premium'], priority: 2 },
  { slug: 'loft-conversion-calculator', title: 'Loft Conversion Cost Calculator', description: 'Estimate loft conversion costs by type (Velux, dormer, hip-to-gable, mansard). See ROI and value added.', category: 'building', icon: 'Hammer', keywords: ['loft conversion', 'attic conversion', 'dormer', 'loft extension'], priority: 2 },
  { slug: 'extension-cost-calculator', title: 'Extension Cost Calculator', description: 'Estimate home extension costs per m² for single/double storey, side return and wrap-around extensions.', category: 'building', icon: 'Hammer', keywords: ['extension cost', 'house extension', 'rear extension', 'building costs'], priority: 2 },
  { slug: 'childcare-entitlement-calculator', title: '30 Hours Free Childcare Calculator', description: 'Check free childcare entitlement by age (15/30 hours). See savings with Tax-Free Childcare.', category: 'benefits', icon: 'Shield', keywords: ['30 hours', 'free childcare', 'childcare entitlement', '15 hours', 'working parents'], priority: 1 },
  { slug: 'stock-unit-calculator', title: 'Livestock Stock Unit Calculator', description: 'Calculate total livestock units for cattle, sheep, pigs and horses. See land requirement at 2 SU/ha.', category: 'farming', icon: 'Wheat', keywords: ['stock units', 'livestock units', 'stocking rate', 'cattle sheep'], priority: 2 },
  ...
  // MATH
  { slug: 'mean-median-mode-calculator', title: 'Mean, Median & Mode Calculator', description: 'Calculate mean, median, mode, range, sum, min and max from a set of numbers. Shows sorted data.', category: 'math', icon: 'Calculator', keywords: ['mean', 'median', 'mode', 'average', 'statistics'], priority: 1 },
  { slug: 'prime-number-calculator', title: 'Prime Number Checker', description: 'Check if a number is prime, find prime factorisation, and list primes up to N.', category: 'math', icon: 'Calculator', keywords: ['prime number', 'prime checker', 'factorisation', 'prime factor'], priority: 2 },
  // HEALTH
  ...
  { slug: 'birthday-calculator', title: 'Birthday Calculator', description: 'Find your day of birth, star sign, Chinese zodiac, days alive and upcoming milestone birthdays.', category: 'tools', icon: 'Wrench', keywords: ['birthday', 'star sign', 'zodiac', 'born on', 'days alive'], priority: 2 },
  // INSURANCE
  { slug: 'employers-liability-calculator', title: "Employers' Liability Insurance Calculator", description: "Estimate employers' liability insurance premiums by industry and annual wages. Legal requirement for UK businesses.", category: 'insurance', icon: 'ShieldCheck', keywords: ['employers liability', 'EL insurance', 'business insurance', 'employee insurance'], priority: 2 },
  { slug: 'car-insurance-estimate-calculator', title: 'Car Insurance Estimate Calculator', description: 'Estimate car insurance premiums by age, cover level, no claims bonus, insurance group and mileage.', category: 'insurance', icon: 'ShieldCheck', keywords: ['car insurance', 'motor insurance', 'NCB', 'insurance group', 'insurance quote'], priority: 1 },
  { slug: 'home-insurance-calculator', title: 'Home Insurance Estimate Calculator', description: 'Estimate home insurance premiums for buildings, contents or combined cover by property type.', category: 'insurance', icon: 'ShieldCheck', keywords: ['home insurance', 'buildings insurance', 'contents insurance', 'house insurance'], priority: 2 },
  { slug: 'critical-illness-calculator', title: 'Critical Illness Cover Calculator', description: 'Estimate critical illness insurance premiums by age, cover amount, term and smoker status.', category: 'insurance', icon: 'ShieldCheck', keywords: ['critical illness', 'CI cover', 'serious illness', 'cancer cover'], priority: 2 },
  // AUTO
  { slug: 'ev-savings-calculator', title: 'EV vs Petrol Running Cost Calculator', description: 'Compare annual running costs of an electric car vs petrol. See fuel, VED and servicing savings plus CO2 reduction.', category: 'auto', icon: 'Car', keywords: ['EV vs petrol', 'electric car savings', 'EV running cost', 'petrol vs electric'], priority: 1, isTrending: true },
  // TAX
  { slug: 'blind-persons-allowance-calculator', title: "Blind Person's Allowance Calculator", description: "Calculate tax saving from Blind Person's Allowance (£3,070 extra tax-free income).", category: 'tax', icon: 'Receipt', keywords: ['blind person', 'BPA', 'sight impaired', 'disability allowance'], priority: 2 },
  { slug: 'property-cgt-calculator', title: 'Capital Gains Tax on Property Calculator', description: 'Calculate CGT on residential property sales with PPR relief, costs and improvements deductions.', category: 'tax', icon: 'Receipt', keywords: ['property CGT', 'house sale tax', 'PPR relief', 'residential CGT'], priority: 1 },
  // EDUCATION
  { slug: 'weighted-grade-calculator', title: 'Weighted Average Grade Calculator', description: 'Calculate weighted average from assessment components with different weightings. See UK degree classification.', category: 'education', icon: 'GraduationCap', keywords: ['weighted average', 'weighted grade', 'module grades', 'assessment weighting'], priority: 2 },
  // IMMIGRATION
  ...
  { slug: 'teachers-pension-calculator', title: "Teachers' Pension Calculator", description: "Project your Teachers' Pension based on salary, years of service and accrual rate (1/57th career average).", category: 'pension', icon: 'PiggyBank', keywords: ['teachers pension', 'TPS', 'career average', 'teaching pension'], priority: 2 },
  // INVESTMENT
  ...
  { slug: 'settlement-agreement-calculator', title: 'Settlement Agreement Calculator', description: 'Estimate settlement package: redundancy, notice, holiday, ex-gratia and tax treatment (£30K tax-free).', category: 'pay', icon: 'Banknote', keywords: ['settlement agreement', 'compromise agreement', 'redundancy package', 'termination'], priority: 2 },
  // MORTGAGE
  { slug: 'buy-to-let-mortgage-calculator', title: 'Buy-to-Let Mortgage Calculator', description: 'Calculate BTL mortgage payments (interest-only and repayment). Check rental coverage stress test.', category: 'mortgage', icon: 'Home', keywords: ['buy to let mortgage', 'BTL mortgage', 'rental coverage', 'landlord mortgage'], priority: 2 },
  { slug: 'house-price-sqft-calculator', title: 'House Price per Square Foot Calculator', description: 'Calculate price per square foot/metre to compare property value. See how it compares to UK averages.', category: 'mortgage', icon: 'Home', keywords: ['price per sqft', 'price per square foot', 'property value', 'house price'], priority: 2 },
  { slug: 'lease-extension-calculator', title: 'Leasehold Extension Calculator', description: 'Estimate lease extension premium including marriage value, ground rent and professional fees.', category: 'mortgage', icon: 'Home', keywords: ['lease extension', 'leasehold', 'marriage value', 'ground rent', 'lease premium'], priority: 2 },
  // LOANS
  { slug: 'student-loan-interest-calculator', title: 'Student Loan Interest Calculator', description: 'Calculate your student loan interest rate by income. See how fast your balance grows with compound interest.', category: 'loans', icon: 'CreditCard', keywords: ['student loan interest', 'RPI', 'loan balance', 'interest rate'], priority: 2 },
  { slug: 'debt-consolidation-calculator', title: 'Debt Consolidation Calculator', description: 'Compare current debt payments vs a consolidation loan. See if you save on monthly payments and total interest.', category: 'loans', icon: 'CreditCard', keywords: ['debt consolidation', 'combine debts', 'consolidation loan', 'one payment'], priority: 2 },
  { slug: 'postgraduate-loan-calculator', title: 'Postgraduate Loan Repayment Calculator', description: 'Calculate postgraduate loan repayments at 6% above £21,000. See if your balance is growing or shrinking.', category: 'loans', icon: 'CreditCard', keywords: ['postgraduate loan', 'masters loan', 'PG loan', 'postgrad repayment'], priority: 2 },
  // ENERGY
  { slug: 'epc-calculator', title: 'EPC Rating Improvement Calculator', description: 'Estimate your EPC rating and see which upgrades will improve it most. Includes costs and annual savings.', category: 'energy', icon: 'Zap', keywords: ['EPC', 'energy performance', 'EPC rating', 'energy efficiency', 'EPC improvement'], priority: 1, isTrending: true },
  // CONSTRUCTION
  { slug: 'bathroom-cost-calculator', title: 'Bathroom Cost Calculator', description: 'Estimate bathroom renovation costs for budget, mid-range and premium finishes with optional extras.', category: 'building', icon: 'Hammer', keywords: ['bathroom cost', 'bathroom renovation', 'bathroom refit', 'shower room'], priority: 2 },
  { slug: 'kitchen-cost-calculator', title: 'Kitchen Cost Calculator', description: 'Estimate kitchen installation costs by budget level. Includes units, worktops, appliances and labour.', category: 'building', icon: 'Hammer', keywords: ['kitchen cost', 'new kitchen', 'kitchen renovation', 'kitchen units'], priority: 2 },
  { slug: 'timber-calculator', title: 'Timber Calculator — Board Feet & Cost', description: 'Calculate timber volume, total length and cost for construction projects. Common size presets included.', category: 'building', icon: 'Hammer', keywords: ['timber', 'wood', 'lumber', 'timber volume', 'construction timber'], priority: 2 },
  { slug: 'underfloor-heating-calculator', title: 'Underfloor Heating Calculator', description: 'Compare water, electric mat and cable underfloor heating. See install costs and running costs vs radiators.', category: 'building', icon: 'Hammer', keywords: ['underfloor heating', 'UFH', 'radiant heating', 'floor heating'], priority: 2 },
  // EDUCATION
  { slug: 'student-allowance-calculator', title: 'Bursary & Scholarship Impact Calculator', description: 'Calculate total student support from maintenance loan plus NHS, teacher training, DSA and other bursaries.', category: 'education', icon: 'GraduationCap', keywords: ['bursary', 'scholarship', 'student allowance', 'NHS bursary', 'DSA'], priority: 2 },
  // PAY
  { slug: 'night-shift-calculator', title: 'Night Shift Allowance Calculator', description: 'Calculate night shift premium at 15-100% rates. See annual extra earnings from night work.', category: 'pay', icon: 'Banknote', keywords: ['night shift', 'night premium', 'unsocial hours', 'shift pay'], priority: 2 },
  { slug: 'benefits-in-kind-calculator', title: 'Benefits in Kind (P11D) Calculator', description: 'Calculate tax on company benefits — car, medical insurance, gym, phone and more. See monthly tax impact.', category: 'pay', icon: 'Banknote', keywords: ['benefits in kind', 'P11D', 'BiK tax', 'company benefits', 'perks tax'], priority: 2 },
  // INVESTMENT
  { slug: 'regular-savings-calculator', title: 'Regular Savings Calculator', description: 'Calculate returns on a regular saver account with monthly deposits. See effective vs headline rate.', category: 'investment', icon: 'TrendingUp', keywords: ['regular saver', 'monthly savings', 'savings account', 'AER'], priority: 2 },
  // PAY
  { slug: 'business-mileage-calculator', title: 'Business Mileage Calculator', description: 'Compare HMRC mileage allowance vs actual fuel costs. See if you profit or lose from the 45p/25p rates.', category: 'pay', icon: 'Banknote', keywords: ['business mileage', 'HMRC mileage', 'mileage profit', '45p rate', 'fuel vs allowance'], priority: 2 },
  // INVESTMENT
  { slug: 'wealth-growth-calculator', title: 'Wealth Growth Projector', description: 'Project wealth growth over time with annual savings and compound returns. See milestones (£100K, £1M).', category: 'investment', icon: 'TrendingUp', keywords: ['wealth growth', 'wealth projector', 'net worth', 'millionaire calculator'], priority: 2 },
  { slug: 'cgt-on-shares-calculator', title: 'CGT on Shares Calculator', description: 'Calculate capital gains tax on share sales. Includes annual exempt amount, basic/higher rates and ISA tip.', category: 'investment', icon: 'TrendingUp', keywords: ['CGT shares', 'share tax', 'stock tax', 'investment tax', 'capital gains shares'], priority: 1 },
  { slug: 'dividend-income-calculator', title: 'Dividend Income Calculator', description: 'Calculate annual dividend income and project portfolio growth with or without reinvestment (DRIP).', category: 'investment', icon: 'TrendingUp', keywords: ['dividend income', 'dividend yield', 'DRIP', 'passive income', 'dividend investing'], priority: 2 },
  // TAX
  { slug: 'non-dom-tax-calculator', title: 'Non-Dom Tax Calculator (FIG Regime)', description: 'Calculate tax under the new FIG regime for non-domiciled UK residents. 4-year foreign income exemption.', category: 'tax', icon: 'Receipt', keywords: ['non-dom', 'FIG', 'foreign income', 'non-domiciled', 'remittance basis'], priority: 2, isTrending: true },
  // BUSINESS
  { slug: 'annual-investment-allowance-calculator', title: 'Annual Investment Allowance Calculator', description: 'Calculate AIA tax relief on plant & machinery spending. 100% deduction on first £1M.', category: 'business', icon: 'Briefcase', keywords: ['AIA', 'annual investment allowance', 'plant machinery', 'capital spending'], priority: 2 },
  // MORTGAGE
  ...
  // ENERGY
  { slug: 'epc-rating-comparison-calculator', title: 'EPC Band Comparison Calculator', description: 'Compare energy costs between EPC bands. See annual savings from upgrading your rating.', category: 'energy', icon: 'Zap', keywords: ['EPC comparison', 'EPC upgrade', 'energy cost', 'EPC band'], priority: 2 },
  // INVESTMENT
  { slug: 'help-to-save-calculator', title: 'Help to Save Calculator', description: 'Calculate Help to Save returns with the 50% government bonus. Max £50/month for 4 years.', category: 'investment', icon: 'TrendingUp', keywords: ['help to save', 'government bonus', '50% bonus', 'low income savings'], priority: 2 },
  { slug: 'ns-i-savings-calculator', title: 'NS&I Savings Calculator', description: 'Calculate savings interest with different compounding frequencies. See AER vs nominal rate.', category: 'investment', icon: 'TrendingUp', keywords: ['NS&I', 'savings interest', 'compounding', 'AER', 'interest rate'], priority: 2 },
  // HEALTH
  { slug: 'bmi-children-calculator', title: 'BMI Calculator for Children', description: 'Calculate BMI for children aged 2-18 with age and gender-adjusted interpretation.', category: 'health', icon: 'Heart', keywords: ['child BMI', 'children BMI', 'child weight', 'paediatric BMI'], priority: 2 },
  // MORTGAGE
  { slug: 'offset-mortgage-calculator', title: 'Offset Mortgage Calculator', description: 'Calculate interest saved by offsetting savings against your mortgage. See equivalent tax-free rate.', category: 'mortgage', icon: 'Home', keywords: ['offset mortgage', 'savings offset', 'interest saving', 'offset account'], priority: 2 },
  { slug: 'ground-rent-calculator', title: 'Ground Rent Calculator', description: 'Calculate ground rent over time with escalation. Flag onerous rents. Includes doubling and RPI clauses.', category: 'mortgage', icon: 'Home', keywords: ['ground rent', 'leasehold', 'rent escalation', 'onerous ground rent'], priority: 2 },
  { slug: 'service-charge-calculator', title: 'Service Charge Calculator', description: 'Estimate your leasehold service charge from building costs. Includes insurance, maintenance and reserve fund.', category: 'mortgage', icon: 'Home', keywords: ['service charge', 'leasehold costs', 'management fee', 'building insurance'], priority: 2 },
  // PENSION
  { slug: 'pension-consolidation-calculator', title: 'Pension Consolidation Calculator', description: 'Compare keeping multiple pension pots vs consolidating into one. See fee savings over time.', category: 'pension', icon: 'PiggyBank', keywords: ['pension consolidation', 'combine pensions', 'pension fees', 'pension transfer'], priority: 2 },
  { slug: 'employer-pension-contribution-calculator', title: 'Employer Pension Contribution Calculator', description: 'Calculate auto-enrolment pension contributions on qualifying earnings with tax relief.', category: 'pension', icon: 'PiggyBank', keywords: ['employer pension', 'auto enrolment', 'qualifying earnings', 'pension contribution'], priority: 2 },
  // MORTGAGE
  { slug: 'right-to-buy-calculator', title: 'Right to Buy Calculator', description: 'Calculate your Right to Buy discount for council/housing association properties. Up to 70% off.', category: 'mortgage', icon: 'Home', keywords: ['right to buy', 'council house', 'RTB', 'housing discount'], priority: 2 },
  { slug: 'staircasing-calculator', title: 'Shared Ownership Staircasing Calculator', description: 'Calculate the cost of buying a bigger share of your shared ownership home and new rent.', category: 'mortgage', icon: 'Home', keywords: ['staircasing', 'shared ownership', 'buy more share', 'increase share'], priority: 2 },
  // PENSION
  { slug: 'pension-lump-sum-calculator', title: 'Pension Lump Sum Calculator (PCLS)', description: 'Compare taking 0-100% as lump sum. See tax-free portion, tax on excess and remaining pot for drawdown.', category: 'pension', icon: 'PiggyBank', keywords: ['pension lump sum', 'PCLS', 'tax free cash', '25% pension', 'pension withdrawal'], priority: 2 },
  // FARMING
  { slug: 'elm-payment-calculator', title: 'BPS/ELM Payment Calculator', description: 'Calculate Sustainable Farming Incentive and ELM payments for 10+ environmental actions.', category: 'farming', icon: 'Wheat', keywords: ['ELM', 'SFI', 'environmental land management', 'farming payments', 'BPS'], priority: 1 },
  { slug: 'farm-tenancy-calculator', title: 'Farm Tenancy Rent Review Calculator', description: 'Compare your farm rent to market rates. See rent as percentage of revenue for rent review preparation.', category: 'farming', icon: 'Wheat', keywords: ['farm tenancy', 'rent review', 'agricultural rent', 'farm rent'], priority: 2 },
  // EDUCATION
  ...
  // TAX
  { slug: 'making-tax-digital-calculator', title: 'Making Tax Digital Readiness Calculator', description: 'Check if MTD for Income Tax applies to you. See deadlines, requirements and software costs.', category: 'tax', icon: 'Receipt', keywords: ['MTD', 'making tax digital', 'digital records', 'quarterly returns'], priority: 1, isTrending: true },
  { slug: 'tax-bracket-visualizer', title: 'Tax Bracket Visualizer', description: 'See your income split across tax bands with a visual bar. Highlights the 60% tax trap at £100-125K.', category: 'tax', icon: 'Receipt', keywords: ['tax brackets', 'tax bands', 'marginal rate', '60% trap', 'effective rate'], priority: 1 },
  // BUSINESS
  { slug: 'business-mileage-record-calculator', title: 'Business Mileage Log Calculator', description: 'Log business trips with dates and mileage. Calculate HMRC mileage allowance claim automatically.', category: 'business', icon: 'Briefcase', keywords: ['mileage log', 'mileage record', 'HMRC log', 'business trips'], priority: 2 },
  // PENSION (already at 18, but this is a valuable one)
  { slug: 'pension-sharing-divorce-calculator', title: 'Pension Sharing on Divorce Calculator', description: 'Calculate pension division in divorce. Compare sharing orders with different splits.', category: 'pension', icon: 'PiggyBank', keywords: ['pension sharing', 'divorce pension', 'pension split', 'PSO'], priority: 2 },
  // BENEFITS
  ...
  // TAX
  { slug: 'inheritance-tax-pension-calculator', title: 'Inheritance Tax on Pensions Calculator (2027)', description: 'Compare IHT before and after April 2027 when pensions enter the estate. See extra tax liability.', category: 'tax', icon: 'Receipt', keywords: ['IHT pension', 'pension inheritance tax', 'pension death tax', '2027 pension'], priority: 1, isTrending: true },
  // BUSINESS
  { slug: 'mtd-readiness-calculator', title: 'MTD Readiness Checklist', description: 'Score your Making Tax Digital readiness across 10 key criteria. See what you still need to do.', category: 'business', icon: 'Briefcase', keywords: ['MTD checklist', 'tax digital readiness', 'quarterly reporting', 'MTD preparation'], priority: 2, isTrending: true },
  // AUTO
  { slug: 'congestion-charge-calculator', title: 'London Congestion Charge Calculator', description: 'Calculate annual Congestion Charge cost. Check EV and Blue Badge exemptions.', category: 'auto', icon: 'Car', keywords: ['congestion charge', 'London driving', 'C-charge', 'central London'], priority: 2 },
  // EDUCATION
  ...
  // AUTO (trending)
  { slug: 'pay-per-mile-calculator', title: 'EV Pay-Per-Mile Road Pricing Calculator', description: 'Compare potential road pricing costs vs current VED and fuel duty. Prepare for future EV taxation.', category: 'auto', icon: 'Car', keywords: ['pay per mile', 'road pricing', 'EV tax', 'road user charge'], priority: 2, isTrending: true },
  // TAX (trending)
  { slug: 'high-council-tax-calculator', title: 'High-Value Property Council Tax Calculator (2028)', description: 'Estimate council tax with proposed surcharge for Band H+ properties. See all bands including new I and J.', category: 'tax', icon: 'Receipt', keywords: ['high value council tax', 'council tax surcharge', 'band H', 'mansion tax'], priority: 2, isTrending: true },
  { slug: 'ni-salary-sacrifice-2029-calculator', title: 'NI on Salary Sacrifice Calculator (2029)', description: 'Compare current salary sacrifice NI savings vs proposed 2029 rules. See how much you\'ll lose.', category: 'tax', icon: 'Receipt', keywords: ['NI salary sacrifice', '2029 pension', 'salary sacrifice change', 'pension NI'], priority: 2, isTrending: true },
  // BUSINESS
  ...
  // EDUCATION
  { slug: 'student-budget-planner-calculator', title: 'Student Budget Planner', description: 'Plan your weekly student budget with income from loan, job and parents against term-time expenses.', category: 'education', icon: 'GraduationCap', keywords: ['student budget', 'university budget', 'term budget', 'weekly budget'], priority: 2 },
  // BENEFITS
  { slug: 'care-cost-calculator', title: 'Care Home Cost Calculator', description: 'Estimate care costs and means-testing. See if you\'re self-funded, means-tested or council-funded.', category: 'benefits', icon: 'Shield', keywords: ['care home', 'care costs', 'means test', 'residential care', 'elderly care'], priority: 2 },
  // PAY
  { slug: 'minimum-wage-calculator', title: 'Minimum Wage Calculator (NMW/NLW)', description: 'Calculate earnings at National Minimum/Living Wage rates by age group. Weekly, monthly and annual.', category: 'pay', icon: 'Banknote', keywords: ['minimum wage', 'NMW', 'NLW', 'living wage', 'hourly rate'], priority: 1 },
  // MORTGAGE
  { slug: 'first-homes-scheme-calculator', title: 'First Homes Scheme Calculator', description: 'Calculate First Homes discounted price (30-50% off). Check if you can afford with income and deposit.', category: 'mortgage', icon: 'Home', keywords: ['first homes', 'first homes scheme', 'discounted home', 'affordable housing'], priority: 2 },
  ...
  // BUSINESS
  { slug: 'invoice-profit-calculator', title: 'Invoice & Job Profit Calculator', description: 'Calculate profit margin and markup on jobs. Add VAT and generate invoice total.', category: 'business', icon: 'Briefcase', keywords: ['invoice', 'job profit', 'margin', 'markup', 'quote'], priority: 2 },
  { slug: 'employee-vs-contractor-calculator', title: 'Employee vs Contractor Calculator', description: 'Compare take-home pay as an employee vs contractor for the same total cost to the hiring company.', category: 'business', icon: 'Briefcase', keywords: ['employee vs contractor', 'perm vs contract', 'PAYE vs Ltd', 'employment status'], priority: 2 },
  // ENERGY
  { slug: 'standing-charge-savings-calculator', title: 'Standing Charge Savings Calculator', description: 'Calculate how much you pay in standing charges alone. Compare zero standing charge tariffs.', category: 'energy', icon: 'Zap', keywords: ['standing charge', 'zero standing', 'fixed charge', 'energy standing'], priority: 2 },
  { slug: 'gas-cost-calculator', title: 'Gas Cost Calculator', description: 'Calculate annual gas bill from kWh usage, unit rate and standing charge.', category: 'energy', icon: 'Zap', keywords: ['gas cost', 'gas bill', 'gas calculator', 'gas usage'], priority: 2 },
  // MATH
  { slug: 'exponent-calculator', title: 'Exponent / Power Calculator', description: 'Calculate any number raised to any power. See common powers of your base number.', category: 'math', icon: 'Calculator', keywords: ['exponent', 'power', 'raised to', 'indices', 'powers'], priority: 2 },
  { slug: 'logarithm-calculator', title: 'Logarithm Calculator', description: 'Calculate log₁₀, ln, log₂ and custom base logarithms. Includes antilog and log rules.', category: 'math', icon: 'Calculator', keywords: ['logarithm', 'log', 'natural log', 'ln', 'log base'], priority: 2 },
  // BUSINESS
  { slug: 'employee-cost-breakdown-calculator', title: 'Employee Cost Breakdown Calculator', description: 'Calculate true cost of employment including NI, pension, training, equipment and recruitment.', category: 'business', icon: 'Briefcase', keywords: ['employee cost', 'true cost', 'cost of hiring', 'employment overhead'], priority: 2 },
  { slug: 'contractor-vs-perm-calculator', title: 'Contractor vs Permanent Salary Calculator', description: 'Compare contractor day rate vs permanent salary. See the premium needed to match perm benefits.', category: 'business', icon: 'Briefcase', keywords: ['contractor vs perm', 'day rate vs salary', 'contract premium', 'freelance vs employed'], priority: 2 },
  // EDUCATION
  { slug: 'postgraduate-loan-cost-calculator', title: 'Postgraduate Loan Total Cost Calculator', description: 'Calculate total postgraduate loan repayment over 30 years with salary growth projections.', category: 'education', icon: 'GraduationCap', keywords: ['PG loan cost', 'postgrad total', 'masters loan cost', 'PhD loan'], priority: 2 },
  // TOOLS
  { slug: 'wedding-cost-calculator', title: 'Wedding Cost Calculator (Detailed)', description: 'Calculate detailed wedding costs across 17 categories with per-guest items. See cost per guest.', category: 'tools', icon: 'Wrench', keywords: ['wedding cost', 'wedding budget', 'wedding planning', 'wedding price'], priority: 2 },
  { slug: 'time-duration-calculator', title: 'Time Duration Calculator', description: 'Calculate hours and minutes between two times. Includes decimal hours for timesheets.', category: 'tools', icon: 'Wrench', keywords: ['time duration', 'hours between', 'time calculator', 'timesheet'], priority: 2 },
  { slug: 'split-bill-calculator', title: 'Split Bill Calculator', description: 'Split a bill between multiple people with itemised costs. Add people and items dynamically.', category: 'tools', icon: 'Wrench', keywords: ['split bill', 'bill splitter', 'share cost', 'divide bill'], priority: 2 },
  { slug: 'speed-distance-time-calculator', title: 'Speed, Distance & Time Calculator', description: 'Calculate speed, distance or time from the other two. Miles and km with the SDT triangle formula.', category: 'tools', icon: 'Wrench', keywords: ['speed distance time', 'SDT', 'how long', 'how far', 'how fast'], priority: 2 },
  // BUSINESS
  { slug: 'profit-and-loss-calculator', title: 'Profit & Loss Calculator', description: 'Build a simple P&L statement. Enter revenue, COGS and overheads to see gross and net profit margins.', category: 'business', icon: 'Briefcase', keywords: ['profit and loss', 'P&L', 'income statement', 'business profit'], priority: 1 },
  { slug: 'freelance-quote-calculator', title: 'Freelance Quote Calculator', description: 'Build a quote from hourly rate, hours and materials. Add profit margin and VAT.', category: 'business', icon: 'Briefcase', keywords: ['freelance quote', 'job quote', 'estimate', 'pricing'], priority: 2 },
]
