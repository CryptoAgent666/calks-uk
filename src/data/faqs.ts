...
export const CALCULATOR_FAQS: Record<string, FAQ[]> = {
  ...
  'capital-gains-tax-calculator': [
    ...
    { question: 'What are the CGT rates for 2025/26?', answer: 'Basic-rate taxpayers pay 18% on gains from residential property and 10% on other assets. Higher and additional-rate taxpayers pay 24% on residential property and 20% on other assets.' },
