...
export const CALCULATOR_FAQS: Record<string, FAQ[]> = {
  ...
  'pension-tax-relief-calculator': [
    ...
    { question: `Why pension tax relief is the best deal in UK finance.`,  answer: `Basic-rate taxpayer: £80 contribution becomes £100 in pension (25% uplift). Higher-rate: £60 effective cost becomes £100 in pension (67% uplift). Additional-rate: £55 effective cost becomes £100 in pension (82% uplift). PLUS investment growth tax-free inside the pension. AND 25% of withdrawals are tax-free at retirement. The combined effect: £1 of higher-rate-relief pension contribution is worth £1.50-£1.80 in 25 years vs the same £1 invested in an ISA from net income.` },
    { question: `Annual Allowance — £60,000 explained.`,  answer: `You can contribute up to £60,000 (2026/27) per tax year and receive full tax relief. Contributions above attract Annual Allowance Charge at your marginal rate (effectively reversing the tax relief). 'Contributions' include personal, employer, and (for Defined Benefit) the value of accrued benefits. Salary sacrifice is technically an employer contribution. The £60,000 is the TOTAL of all inputs across all your pensions. You can use Carry Forward of unused allowance from the previous 3 tax years if you were a member of a registered scheme then.` },
    { question: `The Tapered Annual Allowance — high earners beware.`,  answer: `For 'high income individuals' (Adjusted Income > £260,000), the £60,000 AA tapers down by £1 for every £2 of income above £260,000. Minimum £10,000 (reached at £360,000 adjusted income). 'Adjusted income' includes ALL taxable income plus employer pension contributions. 'Threshold income' (£200,000) is income excluding pension contributions — must exceed this for taper to apply. Many doctors and senior professionals get caught by this — careful planning required to avoid the charge.` },
